...
class ChatbotGUI:
    def __init__(self, title: str, gif_path: str, show_timestamps: bool = True, default_voice_options: dict = None, startup_callback: Callable = None):
        # app object
        self.app = wx.App()
